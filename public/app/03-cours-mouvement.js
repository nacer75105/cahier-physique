...
sections:[
 ...
 {id:"s2", titre:"Le principe d'inertie : rien ne change sans raison", blocs:[
  ...
  {t:"check", q:"Un parachutiste descend à vitesse constante. Que peut-on dire des forces qui s'exercent sur lui ?",
   choix:["Seul le poids agit","La force de l'air est plus grande que le poids","Elles se compensent exactement","Il n'y a aucune force"], bonne:2,
   expl:["Si seul le poids agissait, il accélérerait sans cesse. C'est à peu près le cas dans les toutes premières secondes du saut, tant que sa vitesse est faible et que l'air le freine peu.",
         "Si la force de l'air l'emportait, il **ralentirait**. Or sa vitesse ne change pas : les deux forces sont égales.",
         "Exact : vitesse constante et trajectoire rectiligne signifient $Σ@v{F} = @v{0}$. Le frottement de l'air compense exactement le poids.",
 ...
 {id:"s4", titre:"La chute libre : quand le poids agit seul", blocs:[
  ...
  {t:"check", q:"Une balle lancée verticalement vers le haut atteint le sommet de sa trajectoire : à cet instant, sa vitesse est nulle. Que vaut la somme des forces à cet instant (air négligé) ?",
   choix:["Elle est nulle, puisque la vitesse est nulle","Le poids, dirigé vers le bas","Une force vers le haut, qui vient de s'épuiser","Elle change de sens à cet instant"], bonne:1,
   expl:["Une vitesse nulle ne veut pas dire que la vitesse ne change pas. Si la somme des forces était nulle au sommet, la balle y resterait suspendue, immobile. Elle redescend : son vecteur vitesse change, donc une force agit.",
         "Exact. Le poids est la seule force, du début à la fin du vol, et il ne dépend pas de la vitesse. C'est lui qui a ralenti la montée, et c'est lui qui va faire redescendre la balle : sa vitesse est nulle, mais elle **change** encore.",
  ...
  {t:"atelier", titre:"Une luge tirée sur la neige",
   ...
   etapes:[
    ...
    {q:"Que vaut alors la somme de **toutes** les forces qui s'exercent sur la luge ?",
     choix:["$0$ @u{N}, tout se compense","$236{,}2$ @u{N}, en additionnant tout","$40$ @u{N}, dirigés dans le sens du mouvement","$196{,}2$ @u{N}, comme le poids"],
     bonne:2,
     diag:["Les forces **verticales** se compensent, mais pas les horizontales : il reste $40$ @u{N}.","On n'additionne pas des forces de directions différentes comme des nombres. La verticale et l'horizontale se traitent séparément.",
           "",
    ...
    {q:"Dernière étape, la conclusion. Que fait la luge ?",
     choix:["Elle avance à vitesse constante","Elle ralentit puis s'arrête","On ne peut pas conclure sans connaître sa vitesse actuelle","Sa vitesse augmente, dans le sens du mouvement"],
     bonne:3,
     diag:["À vitesse constante, la somme des forces serait nulle. Ici il reste $40$ @u{N} : quelque chose doit changer.","Elle ralentirait si la somme des forces pointait vers l'arrière. Ici elle pointe vers l'avant, du côté de la traction.",
...
exos:[
 ...
 {id:"fo2", niveau:1, type:"qcm", enonce:"Un palet glisse en ligne droite à vitesse constante sur une patinoire. Que vaut la somme des forces qui s'exercent sur lui ?",
  choix:["Un vecteur dirigé vers l'avant","Son poids","Le vecteur nul","Un vecteur dirigé vers l'arrière"], bonne:2,
  diag:["Une force vers l'avant le ferait **accélérer**. Or sa vitesse ne change pas.",
 ...
 {id:"fo5", niveau:2, type:"qcm", enonce:"Si la distance entre deux corps est multipliée par 3, par combien la force gravitationnelle est-elle divisée ?",
  choix:["3","6","27","9"], bonne:3,
  diag:["La distance intervient **au carré** au dénominateur. Une distance triplée donne donc $3^2 = 9$ au dénominateur, pas 3.",
...
{id:"fo9", niveau:1, type:"qcm", enonce:"Parmi ces forces, laquelle n'est **pas** une force de contact ?",
  choix:["La tension d'un fil","Le poids","La réaction du sol","Le frottement de l'air"], bonne:1,
  diag:["Un fil doit être attaché à l'objet pour le tirer : il y a bien contact.",
        "",
...
{id:"fo13", niveau:2, type:"qcm", enonce:"Un livre est posé sur une table. Quelle est la force **réciproque** du poids du livre ?",
  choix:["La réaction de la table sur le livre",
         "L'attraction que le livre exerce sur la Terre",
         "Le poids de la table",
         "La force de frottement entre le livre et la table"], bonne:1,
  diag:["C'est la confusion la plus fréquente. La réaction de la table s'exerce sur le **même** objet que le poids — le livre — et c'est pour cela qu'elles se compensent. Une paire action–réaction, elle, se répartit sur deux objets.",
        "",
