 ...
 {id:"s2", titre:"Compter les atomes d'une maille : la population", blocs:[
  ...
  {t:"fig", titre:"Deux mailles cubiques à comparer",
   ...
   objets:[
    ...
    {t:"cercle", c:[2,2.2], r:0.30, couleur:"bleu", remplir:true, opacite:.6, anime:[{attr:'r', values:'0.30;0.36;0.30', dur:'2s'}]},
    ...
    {t:"cercle", c:[8.8,2.2], r:0.30, couleur:"bleu", remplir:true, opacite:.6, anime:[{attr:'r', values:'0.30;0.36;0.30', dur:'2s'}]},
...
exos:[
 ...
 {id:"cr9", niveau:1, type:"num", unite:"atomes",
  ...
  fig:{titre:"Document — une maille à identifier", vue:[0,0,10,7], w:400, h:265,
    ...
    {t:"seg", de:[3.9,2.6], a:[7.9,2.6], couleur:"line2", epais:1.7},
    {t:"seg", de:[3.9,2.6], a:[3.9,6.6], couleur:"line2", epais:1.7},
    {t:"seg", de:[7.9,2.6], a:[7.9,6.6], couleur:"line2", epais:1.7},
    {t:"seg", de:[3.9,6.6], a:[7.9,6.6], couleur:"line2", epais:1.7},
    {t:"seg", de:[2.4,1.4], a:[3.9,2.6], couleur:"line2", epais:1.7},
    ...
    {t:"cercle", c:[3.9,2.6], r:0.36, couleur:"bleu", remplir:true, opacite:.6},
