 ...
 {titre:"Une transformation, c'est un système qui change d'état", blocs:[
  ...
  {t:"fig", titre:"Les atomes se réarrangent, ils ne disparaissent pas",
   ...
   objets:[
    ...
    {t:"liaison", de:[7.6,3], a:[8.6,3], marge:13, anime:[{attr:"stroke-width", values:"2.2;4;2.2", dur:"2.6s", begin:"1.2s"}]},
    {t:"liaison", de:[8.6,3], a:[9.6,3], marge:13, anime:[{attr:"stroke-width", values:"2.2;4;2.2", dur:"2.6s", begin:"1.2s"}]},
    {t:"atome", x:7.6, y:1.4, nom:"H", couleur:"bleu"},
    {t:"atome", x:8.6, y:1.4, nom:"O", couleur:"rouge"},
    {t:"atome", x:9.6, y:1.4, nom:"H", couleur:"bleu"},
    {t:"liaison", de:[7.6,1.4], a:[8.6,1.4], marge:13, anime:[{attr:"stroke-width", values:"2.2;4;2.2", dur:"2.6s", begin:"1.2s"}]},
    {t:"liaison", de:[8.6,1.4], a:[9.6,1.4], marge:13, anime:[{attr:"stroke-width", values:"2.2;4;2.2", dur:"2.6s", begin:"1.2s"}]}
   ],
...
exos:[
 ...
 {id:"tr9", niveau:1, type:"num", enonce:"Quelle quantité de matière représentent $36$ @u{g} d'eau ? La masse molaire de l'eau vaut $18$ @u{g/mol}. Réponds en @u{mol}.",
  ...
  corr:["**Ce que dit l'énoncé.** On a $36$ @u{g} d'eau, et l'on sait qu'une mole d'eau pèse $18$ @u{g}. On cherche combien de moles cela fait.",
        ...
        "**Pour se représenter la chose.** Ces $36$ @u{g} d'eau tiennent dans deux cuillères à soupe — et contiennent pourtant $1{,}2 × 10^{24}$ molécules, soit deux fois le nombre d'Avogadro. C'est le genre de nombre qui explique pourquoi on compte en moles."],
 ...
 {id:"tr10", niveau:2, type:"num", enonce:"On mélange $0{,}30$ @u{mol} de dihydrogène et $0{,}10$ @u{mol} de dioxygène selon $2@c{H_2} + @c{O_2} → 2@c{H_2O}$. Quel est l'avancement maximal, en @u{mol} ?",
  ...
  diag:[{v:0.15, m:"$0{,}15$ @u{mol} est l'avancement qu'autoriserait le **dihydrogène** seul. Le dioxygène s'épuise avant, dès $0{,}10$."},
  ...
  corr:["**Ce que dit l'énoncé.** Deux réactifs en quantités connues, et une équation qui donne leurs coefficients : $2$ pour $@c{H_2}$, $1$ pour $@c{O_2}$.",
        ...
        "**Le contrôle, et le piège évité.** Il y avait pourtant **trois fois plus** de dihydrogène que de dioxygène — et c'est quand même le dioxygène qui limite ? Non : c'est bien le dioxygène qui limite, et il en reste $0{,}30 - 2×0{,}10 = 0{,}10$ @u{mol} de dihydrogène inutilisé. Le limitant n'est jamais celui dont on a le moins, mais celui dont le rapport quantité sur coefficient est le plus petit."],
 ...
 {id:"tr11", niveau:2, type:"num", unite:"mol",
  ...
  rep:0.10, tol:0.006,
  diag:[{v:0.15, m:"$0{,}15$ @u{mol} est l'endroit où le réactif A s'annulerait. Mais le réactif B est déjà épuisé bien avant : la réaction s'est arrêtée à $0{,}10$."},
        {v:0.30, m:"$0{,}30$ @u{mol} est une quantité initiale, lue sur l'axe **vertical**. L'avancement se lit en abscisse."},
        {v:0.05, m:"Regarde de nouveau où la droite rouge touche l'axe horizontal : c'est à $0{,}10$, pas $0{,}05$."}],
  corr:["**Ce que montre le document.** En abscisse l'avancement, en ordonnée les quantités de matière. Deux droites descendent — ce sont les réactifs, qui se consomment — et une monte : le produit, qui se forme.",
        ...
        "**Étape 1 — je repère les deux zéros.** La droite rouge, celle du réactif B, touche l'axe à $x = 0{,}10$. La bleue, celle du réactif A, ne l'atteindrait qu'à $x = 0{,}15$.",
        ...
        "**Étape 3 — je lis la suite du graphique.** Au-delà de $0{,}10$, la partie tracée en pointillé n'a plus de sens physique : elle décrirait un réactif B en quantité négative, ce qui n'existe pas.",
        "**Le contrôle par le réactif en excès.** En $x = 0{,}10$, la droite bleue n'est pas à zéro : il reste du réactif A dans le bécher, et l'on peut lire combien — $0{,}10$ @u{mol}. C'est le signe même d'un réactif en excès, et cela confirme la lecture."],
 ...
 {id:"tr12", niveau:3, type:"num", enonce:"On brûle $4{,}0$ @u{g} de dihydrogène dans un excès de dioxygène, selon $2@c{H_2} + @c{O_2} → 2@c{H_2O}$. Quelle masse d'eau se forme, en grammes ? On donne $M(@c{H_2}) = 2{,}0$ @u{g/mol} et $M(@c{H_2O}) = 18$ @u{g/mol}.",
  ...
  corr:["**Ce que dit l'énoncé.** $4{,}0$ @u{g} de dihydrogène, du dioxygène en excès — donc c'est le dihydrogène qui limite.",
 ...
 {id:"tr13", niveau:2, type:"qcm", enonce:"On fait réagir $0{,}60$ @u{mol} de diazote $@c{N_2}$ avec $1{,}80$ @u{mol} de dihydrogène $@c{H_2}$ selon $@c{N_2} + 3 @c{H_2} → 2 @c{NH_3}$. Que peut-on dire de ce mélange ?",
  ...
  diag:["",
        "Compare les quotients : $@f{0{,}60}{1} = 0{,}60$ pour l'azote, $@f{1{,}80}{3} = 0{,}60$ pour l'hydrogène. Les deux valent $0{,}60$ : aucun n'est en excès.",
        "Même remarque : les deux quotients $@f{n}{ν}$ sont rigoureusement égaux, à $0{,}60$. Le dihydrogène ne restera pas non plus en fin de réaction.",
  ...
  corr:["**Ce que dit l'énoncé.** $0{,}60$ @u{mol} de $@c{N_2}$, $1{,}80$ @u{mol} de $@c{H_2}$, équation $@c{N_2} + 3 @c{H_2} → 2 @c{NH_3}$.",
        ...
        "Pour $@c{N_2}$ : $@f{0{,}60}{1} = 0{,}60$. Pour $@c{H_2}$ : $@f{1{,}80}{3} = 0{,}60$.",
        ...
        "**Je vérifie.** À $x = 0{,}60$ : $n(@c{N_2}) = 0{,}60 - 0{,}60 = 0$ et $n(@c{H_2}) = 1{,}80 - 3×0{,}60 = 0$. Les deux tombent à zéro ensemble : c'est cohérent."],
 ...
 {id:"tr14", niveau:2, type:"qcm", enonce:"Un élève affirme : « Le réactif limitant est forcément celui dont on a introduit le moins de moles au départ. » Que penses-tu de cette affirmation ?",
  choix:["Elle est fausse : il faut comparer $@f{n}{ν}$, pas $n$ seul.",
         "Elle est vraie : le réactif limitant est toujours le moins abondant au départ.",
         "Elle est vraie, car le coefficient stœchiométrique n'intervient jamais dans ce raisonnement.",
         "Elle est fausse : c'est toujours le réactif dont le coefficient est le plus grand qui limite."], bonne:0,
  diag:["",
        "Faux : reprends l'exemple de l'aluminium et du dichlore ($0{,}80$ @u{mol} d'aluminium contre $0{,}90$ @u{mol} de dichlore). L'aluminium est pourtant **moins** abondant, et ce n'est pas lui le limitant.",
  ...
  corr:["**Ce que dit l'affirmation.** Elle compare directement les quantités initiales, sans tenir compte des coefficients de l'équation.",
        ...
        "**Pourquoi.** Le quotient de l'aluminium vaut $@f{0{,}80}{2} = 0{,}40$, celui du dichlore $@f{0{,}90}{3} = 0{,}30$. C'est le plus petit **quotient** qui désigne le limitant, pas la plus petite quantité.",
 ...
 {id:"tr15", niveau:3, type:"num", enonce:"On fait réagir $8{,}1$ @u{g} d'aluminium avec $0{,}60$ @u{mol} de dichlore selon $2 @c{Al} + 3 @c{Cl_2} → 2 @c{AlCl_3}$. On donne $M(@c{Al}) = 27{,}0$ @u{g/mol}, $M(@c{AlCl_3}) = 133{,}5$ @u{g/mol}. Quelle masse de chlorure d'aluminium se forme-t-il ?",
  ...
  corr:["**Ce que donne l'énoncé.** Une masse d'aluminium, une quantité de dichlore déjà en moles, deux masses molaires. Ce qu'on cherche : une masse de produit — il faudra donc passer par les moles.",
        ...
        "**Étape 2 — les deux quotients.** Pour l'aluminium : $@f{0{,}300}{2} = 0{,}150$. Pour le dichlore, déjà en moles : $@f{0{,}60}{3} = 0{,}200$.",
        ...
        "**Étape 5 — la masse de produit.** $m = n × M = 0{,}300 × 133{,}5 = 40{,}05$ @u{g}, soit environ $40{,}1$ @u{g}.",
 ...
 {id:"tr16", niveau:2, type:"num", unite:"mol",
  ...
  fig:{titre:"Document — trois espèces au cours de la réaction", vue:[-0.02,-0.05,0.34,0.68], w:430, h:260,
    ...
    {t:"courbeXY", pts:[[0,0],[0.30,0.60]], couleur:"vert", point:{dur:"2.4s"}},
    {t:"texte", x:0.045, y:0.395, txt:"réactif A", couleur:"bleu", taille:11.5},
  ...
  rep:0.36, tol:0.02,
  diag:[{v:0.60, m:"$0{,}60$ @u{mol} est la valeur que prendrait la droite verte **si elle continuait jusqu'à $x=0{,}30$**. Mais la réaction s'arrête bien avant, dès que le réactif A (bleu) touche zéro."},
        ...
        {v:0.30, m:"$0{,}30$ @u{mol} est l'endroit où le réactif B (rouge) se serait annulé s'il avait été seul en jeu. Mais A s'arrête avant lui, à $x=0{,}18$."}],
  corr:["**Ce que montre le document.** Deux droites descendent (les réactifs A et B), une monte (le produit). En abscisse, l'avancement ; en ordonnée, une quantité de matière.",
        "**Étape 1 — je repère où chaque réactif s'annulerait.** La droite bleue (A) touche l'axe à $x = 0{,}18$. La droite rouge (B) ne l'atteindrait qu'à $x = 0{,}30$.",
        ...
        "**Étape 4 — je lis la droite verte à $x = 0{,}18$.** Sa valeur vaut $0{,}36$ @u{mol}.",
        "**Le contrôle.** Le produit continue de monter tant que $x$ progresse ; comme la réaction n'avance plus au-delà de $0{,}18$, la portion de droite verte après ce point n'a plus de sens physique — exactement comme pour les réactifs."],
