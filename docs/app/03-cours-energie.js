...
/* ======== 11. TRAVAIL ET ÉNERGIE MÉCANIQUE ======== */
{
...
sections:[
 {id:"s1", titre:"Le travail d'une force", blocs:[
  ...
  {t:"fig", titre:"Seule l'ombre de la force sur le sol travaille",
   ...
   note:"Plus la corde se redresse, plus l'ombre raccourcit. À 90°, il n'y a plus d'ombre du tout, donc plus de travail."},
  {t:"formule", titre:"Travail d'une force constante",
   x:"$W = F × d × cos(α)$",
   note:"$W$ en @u{J} · $F$ en @u{N} · $d$ en @u{m}, la longueur du déplacement en ligne droite, du point de départ au point d'arrivée · $α$ est l'angle entre la force et le déplacement. Valable pour une force **constante** (même valeur, même direction, même sens) pendant tout le déplacement."},
  ...
  {t:"p", x:"Ces trois lignes suffisent presque toujours. Un travail **moteur** apporte de l'énergie à l'objet, un travail **résistant** lui en retire — c'est le cas des frottements, toujours opposés au mouvement. Savoir si l'objet accélère demande de faire le **bilan** de tous les travaux : c'est le théorème de l'énergie cinétique, dans la section suivante. Et une force perpendiculaire au déplacement ne transfère rien du tout : c'est pour cela que la réaction d'un support **fixe**, perpendiculaire au support, ne travaille pas (les frottements sont comptés à part)."},
  {t:"exemple", titre:"Exemple guidé — trois travaux à comparer", enonce:"Une caisse de $20$ @u{kg} est tirée horizontalement sur $5{,}0$ @u{m} par une force horizontale de $80$ @u{N}. Une force de frottement de $30$ @u{N} s'y oppose. Calculer le travail de chaque force. On prend $g = 9{,}81$ @u{N/kg}.", etapes:[
   ...
   {q:"Le poids", r:"Il est vertical, le déplacement est horizontal : $α = 90°$, donc $W = 0$ @u{J}. Le poids ne travaille pas ici. Du coup, la masse et $g$ donnés dans l'énoncé ne servent pas : un énoncé peut contenir des données inutiles, et savoir les écarter fait partie de l'exercice."},
  ...
  {t:"check", q:"Tu tires un chariot avec une corde inclinée de $60°$ par rapport au sol. La force vaut $100$ @u{N} et le chariot avance de $10$ @u{m}. Quel est le travail de la force ?",
   choix:["$500$ @u{J}","$1000$ @u{J}","$-500$ @u{J}","$0$ @u{J}"], bonne:0,
   expl:["Exact : $W = 100 × 10 × cos(60°) = 100 × 10 × 0{,}5 = 500$ @u{J}. Seule la moitié de la force tire vers l'avant.",
         "$1000$ @u{J}, ce serait avec une corde horizontale. Inclinée, la corde perd une partie de son effet : il faut multiplier par $cos(60°) = 0{,}5$.",
         "Le signe est faux. La corde tire vers l'avant, dans le sens du mouvement : l'angle est inférieur à $90°$, le travail est moteur, donc positif.",
         "Le travail serait nul avec une corde verticale ($90°$). À $60°$, la corde tire encore en partie vers l'avant."]}
  ,{t:"mots", items:[
 ...
 {id:"s2", titre:"L'énergie cinétique : celle du mouvement", blocs:[
  {t:"p", x:"Un objet qui bouge transporte de l'énergie : une voiture lancée peut enfoncer un mur, une boule de bowling renverse les quilles, et pour arrêter l'une ou l'autre il faut que les freins, ou l'obstacle, absorbent cette énergie. À la même vitesse, un camion en transporte plus qu'une voiture ; à la même masse, un objet rapide en transporte beaucoup plus qu'un objet lent. Cette énergie s'appelle l'**énergie cinétique**."},
  ...
  {t:"fig", titre:"L'énergie cinétique croît comme le carré de la vitesse",
   ...
   objets:[
    ...
    {t:"texte", x:2.5, y:-0.08, txt:"v", couleur:"ink3"},
    {t:"texte", x:5, y:-0.08, txt:"2v", couleur:"ink3"},
    {t:"texte", x:2.05, y:0.3, txt:"Ec", couleur:"bleu", taille:12},
    {t:"texte", x:4.4, y:1.07, txt:"4 × Ec", couleur:"rouge", taille:12}
   ],
   note:"La courbe s'envole : c'est pourquoi les excès de vitesse sont si dangereux."},
  {t:"p", x:"Reprends la caisse de l'exemple de la première section : les travaux de toutes les forces s'ajoutaient en $400 - 150 + 0 + 0 = 250$ @u{J}, et c'était exactement l'énergie gagnée par la caisse. Ce n'est pas un hasard : c'est une loi générale."},
  {t:"formule", titre:"Théorème de l'énergie cinétique",
   x:"$ΔE_c = ΣW$",
   note:"$ΔE_c = E_{c,arrivée} - E_{c,départ}$ : $Δ$ (« delta », vu au chapitre 8) désigne une **variation**, toujours « arrivée moins départ ». $Σ$ (« sigma », le S grec de **S**omme, vu au chapitre 9) : $ΣW$ est la **somme des travaux** de toutes les forces qui s'exercent sur l'objet entre le départ et l'arrivée, chacun avec son signe. Tout est en @u{J}."},
  ...
  {t:"exemple", titre:"Exemple guidé — la caisse de tout à l'heure", enonce:"Reprenons la caisse de $20$ @u{kg} de la section 1, partie à l'arrêt : elle a reçu au total $250$ @u{J} sur $5{,}0$ @u{m}. À quelle vitesse va-t-elle ? Puis on lâche la corde : seul le frottement de $30$ @u{N} agit encore. Sur quelle distance glisse-t-elle avant de s'arrêter ?", etapes:[
   {q:"Écrire le théorème", r:"$ΔE_c = ΣW$. Au départ $E_c = 0$, donc à la fin des $5{,}0$ @u{m} : $E_c = 250$ @u{J}."},
   {q:"En déduire la vitesse", r:"$@f{1}{2} × 20 × v^2 = 250$, donc $v^2 = @f{2 × 250}{20} = 25$ @u{m²/s²} et $v = 5{,}0$ @u{m/s}."},
   {q:"Corde lâchée : ce qui travaille encore", r:"Le poids et la réaction restent perpendiculaires au déplacement : travail nul. Seul reste le frottement : $W = -30 × d$."},
   {q:"Jusqu'à l'arrêt", r:"$E_c$ passe de $250$ @u{J} à $0$, donc $ΔE_c = -250$ @u{J}. D'où $-30 × d = -250$, soit $d ≈ 8{,}3$ @u{m}."},
   {q:"Ce qu'il faut retenir", r:"Le même théorème donne une **vitesse** dans un sens et une **distance d'arrêt** dans l'autre, sans jamais suivre le mouvement pas à pas."}
  ]},
  {t:"check", q:"Une voiture roule deux fois plus vite. Par combien son énergie cinétique est-elle multipliée ?",
   choix:["2","4","8","1, elle ne change pas"], bonne:1,
   expl:["Ce serait le cas si la vitesse intervenait simplement, sans carré. Or elle est élevée au carré.",
         "Exact : la vitesse est au carré dans $E_c = @f{1}{2}mv^2$. Doubler $v$ multiplie $v^2$ par $2^2 = 4$.",
 ...
 {id:"s3", titre:"L'énergie potentielle de pesanteur : celle de la hauteur", blocs:[
  {t:"idee", x:"Monter un objet, c'est **ranger** de l'énergie en hauteur. Le laisser tomber, c'est la **récupérer**. L'énergie potentielle de pesanteur, c'est ce stock, prêt à se libérer."},
  {t:"p", x:"Monte lentement un sac de masse $m$ d'une hauteur $z$. Ton bras exerce une force égale au poids, $P = m × g$ (chapitre 9), vers le haut, sur une distance $z$ dans le sens du déplacement : tu fournis un travail $m × g × z$. Cette énergie n'est pas perdue : lâche le sac, et son poids la lui rend en travaillant sur la même hauteur. Plus généralement, quand un objet passe d'une altitude $z_A$ à une altitude $z_B$, le travail de son poids vaut $W = m × g × (z_A - z_B)$, **quel que soit le chemin suivi** : seule compte la différence d'altitude. On dit que le poids est une force **conservative**. Les frottements, eux, ne le sont pas : leur travail dépend du chemin parcouru, et ce qu'ils prennent ne revient jamais."},
  ...
  {t:"fig", titre:"Un livre entre l'étagère et la table",
   ...
   note:"Deux origines possibles, le sol ou la table : les valeurs de Epp changent, pas leur différence."},
  {t:"exemple", titre:"Exemple guidé — le livre qui tombe de l'étagère", enonce:"Un livre de $2{,}0$ @u{kg} est posé sur une étagère à $2{,}0$ @u{m} du sol. Il tombe sur une table haute de $0{,}80$ @u{m}. On prend $g = 9{,}81$ @u{N/kg}. Calculer la variation de son énergie potentielle avec deux origines différentes.", etapes:[
   {q:"Origine au sol : sur l'étagère", r:"$z = 2{,}0$ @u{m}, donc $E_{pp} = 2{,}0 × 9{,}81 × 2{,}0 ≈ 39{,}2$ @u{J}."},
   {q:"Origine au sol : sur la table", r:"$z = 0{,}80$ @u{m}, donc $E_{pp} = 2{,}0 × 9{,}81 × 0{,}80 ≈ 15{,}7$ @u{J}. Variation : $15{,}7 - 39{,}2 = -23{,}5$ @u{J}."},
   {q:"Origine sur la table, cette fois", r:"L'étagère est à $z = 2{,}0 - 0{,}80 = 1{,}20$ @u{m} au-dessus de la table : $E_{pp} = 2{,}0 × 9{,}81 × 1{,}20 ≈ 23{,}5$ @u{J}. Sur la table, $z = 0$, donc $E_{pp} = 0$. Variation : $0 - 23{,}5 = -23{,}5$ @u{J}."},
   {q:"Ce qu'il faut remarquer", r:"Les valeurs de $E_{pp}$ ont changé, mais la **variation** est la même : $-23{,}5$ @u{J}. Seule compte la hauteur de chute, $1{,}20$ @u{m}. C'est pour cela que le choix de l'origine est libre."},
   {q:"Où sont passés ces 23,5 J ?", r:"Le livre a accéléré en tombant : cette énergie est devenue de l'énergie de mouvement, $E_c$. C'est l'idée de la section suivante."}
  ]},
  {t:"check", q:"Une randonneuse de $60$ @u{kg} monte d'une vallée à $1200$ @u{m} d'altitude jusqu'à un col à $1500$ @u{m}. L'origine est au niveau de la mer, et $g = 9{,}81$ @u{N/kg}. De combien son énergie potentielle augmente-t-elle ?",
   choix:["$60 × 9{,}81 × 1500 ≈ 883$ @u{kJ}","$60 × 9{,}81 × 1200 ≈ 706$ @u{kJ}","$60 × 9{,}81 × 300 ≈ 177$ @u{kJ}","Rien : l'origine est au niveau de la mer"], bonne:2,
   expl:["$883$ @u{kJ}, c'est son $E_{pp}$ **au col**, comptée depuis la mer. La question demande de combien elle **augmente** entre la vallée et le col.",
         "$706$ @u{kJ}, c'est son $E_{pp}$ **dans la vallée**, au départ. Il faut la différence entre l'arrivée et le départ.",
         "Exact : seule compte la dénivelée, $1500 - 1200 = 300$ @u{m}. $ΔE_{pp} = 60 × 9{,}81 × 300 ≈ 177$ @u{kJ}. On aurait trouvé la même chose avec l'origine dans la vallée.",
         "L'origine fixe le zéro, pas les variations. Elle est montée de $300$ @u{m} : son stock d'énergie a forcément augmenté."]},
 ...
 {id:"s4", titre:"L'énergie mécanique et sa conservation", blocs:[
  {t:"idee", x:"L'**énergie mécanique** est la somme des deux précédentes. Quand seul le poids travaille — ni frottement, ni moteur, ni traction —, elle **ne change pas** : l'énergie passe d'une forme à l'autre sans jamais se perdre."},
  {t:"formule", titre:"Énergie mécanique", x:"$E_m = E_c + E_{pp}$", note:"$E_m$, $E_c$, $E_{pp}$ en @u{J}. Si seul le poids travaille : $E_m$ est constante. Avec frottements : elle diminue."},
  {t:"fig", titre:"Une bille qui descend : l'énergie change de forme",
   ...
   objets:[
    ...
    {t:"texte", x:2.5, y:2.2, txt:"hauteur h", couleur:"ambre", taille:12},
  ...
  {t:"exemple", titre:"Exemple guidé — la vitesse au bas d'une pente", enonce:"Une bille part sans vitesse d'une hauteur $h = 1{,}8$ @u{m} et glisse sans frottement. Quelle est sa vitesse en bas ? On prend $g = 9{,}81$ @u{N/kg}.", etapes:[
   ...
   {q:"Écrire l'énergie mécanique au départ", r:"La bille est immobile : $E_c = 0$. Donc $E_m = E_{pp} = m g h$. Ici $h$ désigne la **hauteur de descente** : $h = z_{départ} - z_{arrivée}$. En plaçant l'origine en bas, $z_{départ} = h$."},
   {q:"Écrire l'énergie mécanique à l'arrivée", r:"L'altitude est nulle : $E_{pp} = 0$. Donc $E_m = E_c = @f{1}{2} m v^2$."},
   {q:"Égaler, puisque seul le poids travaille", r:"$@f{1}{2} m v^2 = m g h$. $m$ est présente des deux côtés : je divise les deux côtés par $m$, et elle disparaît. Il reste $@f{1}{2} v^2 = g h$ — la vitesse ne dépend donc pas de la masse !"},
   {q:"Isoler la vitesse", r:"$v^2 = 2 g h = 2 × 9{,}81 × 1{,}8 ≈ 35{,}3$ @u{m²/s²}, donc $v = @r{35{,}3} ≈ 5{,}9$ @u{m/s}."},
  ...
  {t:"formule", titre:"Le raccourci : la vitesse après une descente de hauteur $h$", x:"$v = @r{2 g h}$", note:"Valable pour un objet parti sans vitesse initiale, quand seul le poids travaille. La masse n'intervient pas, et la forme du chemin (chute verticale, pente, toboggan) non plus. Côté unités, $1$ @u{N/kg} $= 1$ @u{m/s²} : $2 g h$ est bien en @u{m²/s²}, et sa racine en @u{m/s}."}
  ,{t:"figi", nom:"energie"}
  ,{t:"p", x:"Fais descendre la bille et surveille la **barre verte**. Sans frottement, elle ne bouge pas d'un pixel : l'énergie ne fait que passer de la réserve (en ambre) au mouvement (en bleu). Monte ensuite le curseur de frottement : la barre verte se met à descendre, et l'écart avec le trait rouge mesure exactement ce qui est parti en chaleur. (La bille est traitée comme un point qui glisse : on ne compte pas l'énergie de sa rotation.)"}
  ,{t:"methode", titre:"Résoudre un problème par l'énergie", etapes:[
   ...
   "**Égaler les deux si seul le poids travaille.** S'il y a des frottements, leur différence donne exactement l'énergie dissipée.",
   "**Isoler l'inconnue.** Si c'est une vitesse, ne pas oublier la racine carrée à la fin."
  ], exemple:"Une bille lâchée de $2{,}0$ @u{m} : au départ $E_m = m g h$, à l'arrivée $E_m = @f{1}{2} m v^2$. On divise les deux côtés par $m$, donc $v = @r{2 × 9{,}81 × 2{,}0} = @r{39{,}2} ≈ 6{,}3$ @u{m/s}."}

  ,{t:"check", q:"Sur un toboggan sans frottement, de quoi dépend la vitesse en bas ?",
   choix:["De la masse de l'enfant","De la longueur du toboggan","De la pente du toboggan","Seulement de la hauteur de départ"], bonne:3,
   expl:["La masse disparaît du calcul : elle est des deux côtés de l'égalité. Un enfant lourd et un enfant léger arrivent à la même vitesse.",
         ...
         "Exact : $v = @r{2gh}$. Ni la masse, ni la forme du toboggan n'apparaissent — seule compte la dénivelée."]}
 ]},
 ...
 {id:"s5", titre:"Quand les frottements entrent en jeu", blocs:[
  ...
  {t:"formule", titre:"Bilan avec frottements",
   ...
   note:"Tout en @u{J}. Ce travail est toujours **négatif** : les frottements retirent de l'énergie au système. L'**énergie dissipée**, partie en chaleur, est son opposé, un nombre positif : $E_{m,initial} - E_{m,final}$. Valable quand les frottements sont, avec le poids, les seules forces qui travaillent (pas de moteur, pas de traction)."},
  {t:"exemple", titre:"Exemple guidé — combien les frottements ont-ils pris ?", enonce:"Un skieur de $70$ @u{kg} descend $20$ @u{m} de dénivelé et arrive à $15$ @u{m/s}. Il partait sans vitesse. Quelle énergie les frottements ont-ils dissipée ? On prend $g = 9{,}81$ @u{N/kg}.", etapes:[
   {q:"L'énergie disponible au départ", r:"$E_{pp} = m g h = 70 × 9{,}81 × 20 = 13 734$ @u{J}."},
   {q:"L'énergie de mouvement à l'arrivée", r:"$E_c = @f{1}{2} m v^2 = 0{,}5 × 70 × 15^2 = 0{,}5 × 70 × 225 = 7 875$ @u{J}."},
   {q:"Comparer", r:"Il manque $13 734 - 7 875 ≈ 5 900$ @u{J} : l'énergie mécanique a diminué. (On soustrait les valeurs non arrondies : $13 700 - 7 900$ donnerait $5 800$, faux d'une centaine de joules.)"},
   {q:"Conclure", r:"Ces $5{,}9$ @u{kJ} ont été dissipés par les frottements de la neige et de l'air, sous forme de chaleur."},
 ...
 {id:"s6", titre:"La puissance : le travail rapporté au temps", blocs:[
  ...
  {t:"formule", titre:"Puissance moyenne",
   x:"$P = @f{W}{Δt}$",
   note:"$P$ en @u{W} (watt) · $W$ en @u{J} · $Δt$ en @u{s}. $Δt$ (« delta té », comme au chapitre 10) est une **durée** : instant de fin moins instant de début. Un watt, c'est **un joule fourni chaque seconde** — la même relation qu'au chapitre 10, avec le travail à la place de l'énergie électrique."},
  {t:"p", x:"Cette définition explique une phrase que l'on entend souvent sans y penser : une ampoule de $60$ @u{W} ne « contient » pas $60$ joules. Elle en **consomme** $60$ à chaque seconde. Laissée allumée une minute, elle en a consommé $3600$ @u{J} ; une heure, $216 000$ @u{J}. La puissance est un débit, l'énergie est un total — exactement comme le débit d'un robinet et le volume du seau."},
  ...
  {t:"methode", titre:"Calculer une puissance", etapes:[
   ...
   "**Si l'on connaît une force et une vitesse constante**, $P = F × v$ donne directement la réponse. **Sinon, calculer d'abord l'énergie**, avec la formule qui convient : $W = F d$, $W = m g h$, $E_c = @f{1}{2} m v^2$…",
  ...
  {t:"check", q:"Deux grues montent la même charge à la même hauteur. La première met $10$ @u{s}, la seconde $20$ @u{s}. Que peut-on dire ?",
   choix:["La première fournit deux fois plus de travail","La première fournit deux fois moins de travail","Même travail, mais la première développe une puissance deux fois plus grande","Les deux ont la même puissance"], bonne:2,
   expl:["Non : le travail vaut $m g h$. Ni la masse ni la hauteur ne changent, donc le travail non plus. Ce qui change, c'est le temps mis pour le fournir.",
         ...
         "Exact. Le travail ne dépend que de la masse et de la hauteur, identiques ici. C'est la **durée** qui change, donc la puissance : deux fois moins de temps, deux fois plus de puissance.",
  ...
  {t:"check", q:"Un treuil tire un chariot avec une force de $250$ @u{N} à la vitesse constante de $2{,}0$ @u{m/s}. Quelle puissance développe-t-il ?",
   choix:["On ne peut pas savoir sans la durée","$125$ @u{W}","$250$ @u{W}","$500$ @u{W}"], bonne:3,
   expl:["C'est justement ce que $P = F × v$ permet d'éviter : ni la durée ni la distance ne sont nécessaires quand on connaît la force et la vitesse.",
         ...
         "Exact : $P = F × v = 250 × 2{,}0 = 500$ @u{W}. Cette écriture donne la puissance sans passer ni par la durée ni par la distance."]}
 ]},
  ...
  {t:"atelier", titre:"Combien les frottements ont-ils pris ?",
   ...
   etapes:[
    ...
    {q:"Quelle énergie possède-t-il à l'arrivée, en bas, en @u{J} ?",
     ...
     diag:[{v:90, m:"Tu as oublié d'élever la vitesse au carré : $0{,}5 × 30 × 6{,}0 = 90$ @u{J}. Or $E_c = @f{1}{2} m v^2$ et $6{,}0^2 = 36$ : $0{,}5 × 30 × 36 = 540$ @u{J}."},
    ...
    {q:"Quelle énergie les frottements ont-ils dissipée pendant la descente, en @u{J} ?",
     ...
     expl:"$883 - 540 = 343$ @u{J} ont été dissipés. **Ce que « perdu » veut dire.** Ces $343$ joules n'ont pas disparu : ils ont réchauffé — un tout petit peu — le toboggan, le short de l'enfant et l'air alentour. L'énergie totale se conserve toujours ; c'est l'énergie **mécanique** qui diminue, parce qu'une partie a quitté le domaine du mouvement."},
    ...
    {q:"À quelle vitesse serait-il arrivé s'il n'y avait eu aucun frottement, en @u{m/s} ?",
     ...
     diag:[{v:58.9, m:"$58{,}9$ @u{m²/s²} est la valeur de $2 g h$, sous la racine. Il reste à en prendre la racine carrée."},
     ...
     expl:"$v = @r{2 g h} = @r{2 × 9{,}81 × 3{,}0} = @r{58{,}9}$ (en @u{m²/s²} sous la racine) $≈ 7{,}7$ @u{m/s}. **Ce que ce nombre prouve.** Il est plus grand que les $6{,}0$ @u{m/s} observés, et c'est heureux : sans frottement, l'enfant irait forcément plus vite. Si tu avais trouvé une valeur **inférieure** à $6{,}0$, ton calcul serait faux, sans même avoir à le relire. C'est le genre de contrôle qui vaut mieux qu'une relecture."},

    {q:"Un enfant deux fois plus lourd descendrait le même toboggan sans frottement. Sa vitesse en bas serait…",
     choix:["quatre fois plus grande","la même, la masse n'intervient pas","deux fois plus grande","deux fois plus petite"],
     bonne:1,
     diag:["Ni quatre, ni deux : exactement la même. Regarde la formule $v = @r{2gh}$ — la masse n'y figure pas.",
           "",
           "Il aurait deux fois plus d'énergie de hauteur, mais il faut aussi deux fois plus d'énergie pour le lancer à la même vitesse. Les deux se compensent.",
           "Être plus lourd ne ralentit pas : c'est l'intuition qui trompe, comme pour la chute libre."],
     expl:"La vitesse serait exactement la même. **Pourquoi la masse s'en va, une fois de plus.** Écrivons la conservation : $@f{1}{2} m v^2 = m g h$. Le $m$ est présent des deux côtés : on divise les deux côtés par $m$, et il reste $v = @r{2 g h}$ — sans masse. C'est le même phénomène qu'en chute libre : un corps plus lourd emmagasine plus d'énergie en hauteur, mais il en faut d'autant plus pour le mettre en mouvement."}
   ],
 ...
 {id:"s8", titre:"Récapitulatif", blocs:[
  {t:"mots", items:[
   ...
   ["Énergie mécanique ($E_m$)","La somme des deux. Quand seul le poids travaille, elle ne change pas de tout le mouvement."],
  ...
  {t:"tbl", head:["La question ressemble à…","Ce qu'il faut faire"], rows:[
   ...
   ["« Énergie d'un objet qui bouge ? »","$E_c = @f{1}{2} m v^2$ : le carré d'abord, puis la masse, puis la moitié"],
   ["« Énergie d'un objet en hauteur ? »","$E_{pp} = m g z$ ; choisir l'origine au point le plus bas"],
   ["« Une force change la vitesse sur une distance ? »","$ΔE_c = ΣW$ : faire la liste de toutes les forces, avec leur signe"],
   ["« Vitesse en bas d'une pente sans frottement, départ sans vitesse ? »","$v = @r{2gh}$, la masse n'intervient pas"],
   ["« Énergie dissipée par les frottements ? »","$E_{m,départ} - E_{m,arrivée}$ : un nombre **positif**, l'énergie partie en chaleur. Le travail des frottements en est l'opposé : négatif."],
   ["« La vitesse double, et l'énergie ? »","Multipliée par 4"],
   ["« Quelle puissance ? »","L'énergie divisée par la durée en secondes ; ou $P = F × v$ si l'on connaît une force et une vitesse constante"]
  ]},
  {t:"liste", items:[
   "**La méthode énergétique évite de suivre le mouvement** : on compare seulement un état de départ et un état d'arrivée.",
   "**Quand seul le poids travaille**, $E_m$ se conserve : ce que l'on perd en hauteur, on le gagne en vitesse.",
...
exos:[
 {id:"mc1", niveau:1, type:"num", enonce:"Quelle est l'énergie cinétique d'une voiture de $1200$ @u{kg} roulant à $20$ @u{m/s} ? Réponds en @u{kJ}.",
  ...
  diag:[{v:12, m:"Tu as oublié d'élever la vitesse au carré : $0{,}5 × 1200 × 20 = 12 000$ @u{J}, soit $12$ @u{kJ}. Le carré porte sur la vitesse : $20^2 = 400$, donc $E_c = 0{,}5 × 1200 × 400 = 240 000$ @u{J} $= 240$ @u{kJ}."},
 ...
 {id:"mc2", niveau:1, type:"num", enonce:"Un sac de $5{,}0$ @u{kg} est monté de $3{,}0$ @u{m}. De combien son énergie potentielle de pesanteur augmente-t-elle, en @u{J} ? On prend $g = 9{,}81$ @u{N/kg}.",
  ...
  diag:[{v:15, m:"Tu as multiplié la masse par la hauteur en oubliant $g$. La formule est $E_{pp} = m × g × z$."},
        {v:1.7, m:"Tu as fait une division (par exemple $5{,}0 ÷ 3{,}0 ≈ 1{,}7$), et $g$ a disparu en route. L'énergie potentielle est un **produit** de trois facteurs, sans aucune division : $E_{pp} = m × g × z = 5{,}0 × 9{,}81 × 3{,}0$."},
        {v:49, m:"Tu as oublié un facteur : $5{,}0 × 9{,}81 = 49$ @u{N}, c'est le poids. Il reste à multiplier par la hauteur $3{,}0$ @u{m}."}],
  corr:["**Ce que dit l'énoncé.** Un sac de $5{,}0$ @u{kg} monté de $3{,}0$ @u{m}, avec $g = 9{,}81$ @u{N/kg}.",
        ...
        "**Je calcule par étapes.** $5{,}0 × 9{,}81 = 49{,}05$ @u{N}, puis $49{,}05 × 3{,}0 ≈ 147$ @u{J}.",
 ...
 {id:"mc3", niveau:2, type:"num", enonce:"Une caisse est tirée sur $8{,}0$ @u{m} par une force horizontale de $50$ @u{N}, dans le sens du déplacement. Quel est le travail de cette force, en @u{J} ?",
  ...
  corr:["**Ce que dit l'énoncé.** Une force de $50$ @u{N}, **dans le sens du déplacement**, sur $8{,}0$ @u{m}.",
        ...
        "**J'interprète le signe.** Le résultat est positif : le travail est **moteur**. La force apporte $400$ @u{J} à la caisse ; pour savoir si elle accélère, il faudrait connaître aussi les frottements. Si la force avait été opposée au mouvement, on aurait trouvé $-400$ @u{J}."],
  indice:"Force dans le sens du déplacement : le cosinus vaut 1."},

 {id:"mc4", niveau:2, type:"qcm", enonce:"Un serveur porte un plateau à hauteur constante et traverse la salle sur $20$ @u{m}, en ligne droite. Quel est le travail de la force qu'il exerce verticalement sur le plateau ?",
  choix:["Impossible à dire sans connaître la masse","Positif, car il se fatigue","Nul, car la force est perpendiculaire au déplacement","Négatif, car il lutte contre le poids"], bonne:2,
  diag:["La masse n'y change rien : quel que soit son poids, l'angle reste de $90°$ et le cosinus reste nul.",
        "La fatigue physiologique n'est pas le travail au sens de la physique. Les muscles se contractent en permanence et consomment de l'énergie, mais aucune énergie n'est transférée **au plateau**, qui ne monte ni ne descend.",
        "",
        "Il lutte bien contre le poids, mais sans déplacement vertical : l'énergie transférée au plateau est nulle. Un travail résistant supposerait un déplacement opposé à la force."],
  corr:["**Ce que dit l'énoncé.** Un serveur porte un plateau à hauteur constante et avance horizontalement sur $20$ @u{m}.",
        "**Étape 1 — quelle est la direction de la force ?** Pour soutenir le plateau, la main exerce une force **verticale**, dirigée vers le haut.",
        "**Étape 2 — quelle est la direction du déplacement ?** **Horizontale** : le serveur avance, le plateau ne monte ni ne descend.",
        ...
        "**Je lève le paradoxe.** Se fatiguer et travailler au sens de la physique sont deux choses différentes. Les muscles se contractent et consomment de l'énergie, mais **aucune énergie n'est transférée au plateau** : il reste exactement à la même hauteur."],
 ...
 {id:"mc5", niveau:2, type:"num", enonce:"Une bille est lâchée sans vitesse d'une hauteur de $5{,}0$ @u{m}, sans frottement. Quelle est sa vitesse en arrivant au sol, en @u{m/s} ? On prend $g = 9{,}81$ @u{N/kg}.",
  ...
  diag:[{v:49.05, m:"Tu as calculé $g × h$ sans multiplier par 2 ni prendre la racine. La formule est $v = @r{2 g h}$."},
        {v:98.1, m:"Tu as calculé $2 g h$ mais oublié la racine carrée. Ce résultat, $98{,}1$ @u{m²/s²}, est $v^2$, pas $v$."},
        {v:7, m:"Tu as oublié le facteur 2 sous la racine : $@r{9{,}81 × 5{,}0} = @r{49{,}05} ≈ 7{,}0$ @u{m/s}. Ce 2 vient du $@f{1}{2}$ de l'énergie cinétique : $v = @r{2 g h} = @r{98{,}1} ≈ 9{,}9$ @u{m/s}."}],
  corr:["**Ce que dit l'énoncé.** Une bille lâchée **sans vitesse** de $5{,}0$ @u{m}, sans frottement, avec $g = 9{,}81$ @u{N/kg}.",
        ...
        "**Étape 3 — j'égale, puisque seul le poids travaille.** $@f{1}{2} m v^2 = m g h$. La masse apparaît des deux côtés : je divise les deux côtés par $m$, et elle disparaît. Donc $v^2 = 2 g h$.",
        "**Étape 4 — je calcule.** $v^2 = 2 × 9{,}81 × 5{,}0 = 98{,}1$ @u{m²/s²}, puis $v = @r{98{,}1} ≈ 9{,}9$ @u{m/s}, soit environ $36$ @u{km/h}. Ne pas oublier la racine : $98{,}1$ est $v^2$, pas $v$."],
  indice:"$v = @r{2gh}$ — n'oublie pas la racine carrée à la fin."},

 {id:"mc6", niveau:3, type:"num", enonce:"Un skieur de $60$ @u{kg} descend $15$ @u{m} de dénivelé en partant sans vitesse. Les frottements dissipent $4000$ @u{J}. À quelle vitesse arrive-t-il en bas, en @u{m/s} ? On prend $g = 9{,}81$ @u{N/kg}.",
  rep:12.7, tol:0.2, unite:"m/s",
  diag:[{v:17.2, m:"$17{,}2$ @u{m/s}, c'est la vitesse **sans frottement**. Les frottements ont pris $4000$ @u{J} : il faut les retrancher de l'énergie de départ avant de calculer la vitesse."},
        {v:20.7, m:"Tu as **ajouté** les $4000$ @u{J} à l'énergie de départ. Les frottements retirent de l'énergie : $E_c = 8829 - 4000 = 4829$ @u{J}."},
        {v:161, m:"$161$ @u{m²/s²}, c'est $v^2$. Il reste à prendre la racine carrée."},
        {v:4829, m:"$4829$ @u{J} est l'énergie cinétique à l'arrivée. La question demande une **vitesse** : $v = @r{@f{2 E_c}{m}}$."}],
  corr:["**Ce que dit l'énoncé.** Un skieur de $60$ @u{kg}, $15$ @u{m} de dénivelé, départ sans vitesse, et $4000$ @u{J} dissipés par les frottements. On cherche sa vitesse en bas.",
        "**L'idée.** L'énergie de départ se partage à l'arrivée entre le mouvement et la chaleur. Ce qui reste pour le mouvement, c'est l'énergie de départ moins ce que les frottements ont pris.",
        "**Étape 1 — l'énergie mécanique au départ.** Immobile, donc $E_c = 0$. Reste $E_{pp} = m g h = 60 × 9{,}81 × 15 ≈ 8829$ @u{J}.",
        "**Étape 2 — l'énergie cinétique à l'arrivée.** Origine en bas, donc $E_{pp} = 0$ : $E_c = 8829 - 4000 = 4829$ @u{J}.",
        "**Étape 3 — la vitesse.** $@f{1}{2} × 60 × v^2 = 4829$, donc $v^2 = @f{2 × 4829}{60} ≈ 161$ @u{m²/s²} et $v = @r{161} ≈ 12{,}7$ @u{m/s}.",
        "**Je vérifie.** Sans frottement, il serait arrivé à $@r{2 × 9{,}81 × 15} ≈ 17{,}2$ @u{m/s}. Avec des frottements, il arrive moins vite : $12{,}7 < 17{,}2$, c'est cohérent."],
  indice:"Énergie de départ, moins ce qu'ont pris les frottements : c'est l'énergie cinétique à l'arrivée. Puis la vitesse."},
 ...
 {id:"mc7", niveau:3, type:"qcm", enonce:"Deux billes de masses différentes sont lâchées de la même hauteur, sans frottement. Laquelle arrive le plus vite en bas ?",
  ...
  diag:["",
        "La bille lourde possède bien plus d'énergie potentielle — mais il lui en faut aussi davantage pour atteindre une vitesse donnée. Les deux effets se compensent exactement : la masse disparaît du calcul.",
  ...
  indice:"Écris la conservation de l'énergie et regarde si la masse survit quand tu divises par $m$."},

 {id:"mc8", niveau:3, type:"num", enonce:"Une luge est tirée sur $10$ @u{m} de neige plate par une corde horizontale, avec une force de $60$ @u{N} dans le sens du mouvement, contre un frottement de $25$ @u{N}. De combien varie son énergie cinétique, en @u{J} ?",
  ...
  diag:[{v:600, m:"Tu n'as compté que la force de traction. Le théorème de l'énergie cinétique fait intervenir la somme des travaux de **toutes** les forces, frottement compris."},
        ...
        {v:250, m:"$250$ @u{J}, c'est le travail du frottement seul ($25 × 10$), et sans son signe. Il faut compter **toutes** les forces : $ΔE_c = 600 - 250 = 350$ @u{J}."}],
  corr:["**Ce que dit l'énoncé.** Une force de traction de $60$ @u{N} dans le sens du mouvement, un frottement de $25$ @u{N}, sur $10$ @u{m}.",
        ...
        "**Étape 3 — les autres forces.** Le poids et la réaction de la neige sont perpendiculaires au déplacement horizontal : leur travail est nul, ils n'entrent pas dans le bilan.",
        "**Étape 4 — je somme.** $ΔE_c = 600 - 250 = 350$ @u{J}. Le résultat est positif : la luge gagne de l'énergie, donc elle accélère."],
...
{id:"mc9", niveau:1, type:"num", enonce:"Quelle est l'énergie cinétique d'un piéton de $70$ @u{kg} qui marche à $1{,}5$ @u{m/s} ? (arrondis à l'unité)",
  ...
  corr:["**Ce que donne l'énoncé.** Une masse et une vitesse. Ce qu'on cherche : l'énergie que le piéton possède parce qu'il bouge.",
        ...
        "**Étape 1 — le carré, en premier.** $1{,}5^2 = 2{,}25$ @u{m²/s²}. Le carré ne porte que sur la vitesse.",
        "**Étape 2 — je multiplie par la masse.** $70 × 2{,}25 = 157{,}5$ @u{J} (avant de prendre la moitié).",
        "**Étape 3 — je prends la moitié.** $E_c = 0{,}5 × 157{,}5 ≈ 79$ @u{J}.",
        "**Je mets en perspective.** Une voiture de $1200$ @u{kg} à $20$ @u{m/s} emporte $240 000$ @u{J} : trois mille fois plus. Un facteur $17$ vient de la masse, un facteur $178$ du carré de la vitesse."],
 ...
 {id:"mc12", niveau:3, type:"num", enonce:"Une voiture de $1200$ @u{kg} roulant à $20$ @u{m/s} s'arrête en $40$ @u{m}. Quelle est la valeur de la force de freinage, supposée constante, en @u{N} ?",
  ...
  diag:[{v:240000, m:"$240 000$ @u{J} est l'énergie cinétique à dissiper, pas la force. Il reste à la diviser par la distance de freinage."},
        ...
        {v:600, m:"Erreur d'un facteur 10 : $@f{240 000}{40} = 6000$ @u{N}, et non $600$ @u{N}."}],
...
{id:"mc13", niveau:2, type:"num", unite:"J",
  ...
  fig:{titre:"Document — bilan d'énergie le long de la piste", vue:[-0.9,0,7,120], w:410, h:250,
       libre:true, grille:false, axes:false, objets:[
    /* graduations tous les 10 J, chiffrées tous les 20 J : sans elles,
       on ne peut pas lire les 45 J demandés */
    {t:"seg", de:[0,10], a:[6,10], couleur:"line", epais:1}, {t:"seg", de:[-0.07,10], a:[0.07,10], couleur:"ink3", epais:1.2},
    {t:"seg", de:[0,20], a:[6,20], couleur:"line", epais:1}, {t:"seg", de:[-0.07,20], a:[0.07,20], couleur:"ink3", epais:1.2},
    {t:"seg", de:[0,30], a:[6,30], couleur:"line", epais:1}, {t:"seg", de:[-0.07,30], a:[0.07,30], couleur:"ink3", epais:1.2},
    {t:"seg", de:[0,40], a:[6,40], couleur:"line", epais:1}, {t:"seg", de:[-0.07,40], a:[0.07,40], couleur:"ink3", epais:1.2},
    {t:"seg", de:[0,50], a:[6,50], couleur:"line", epais:1}, {t:"seg", de:[-0.07,50], a:[0.07,50], couleur:"ink3", epais:1.2},
    {t:"seg", de:[0,60], a:[6,60], couleur:"line", epais:1}, {t:"seg", de:[-0.07,60], a:[0.07,60], couleur:"ink3", epais:1.2},
    {t:"seg", de:[0,70], a:[6,70], couleur:"line", epais:1}, {t:"seg", de:[-0.07,70], a:[0.07,70], couleur:"ink3", epais:1.2},
    {t:"seg", de:[0,80], a:[6,80], couleur:"line", epais:1}, {t:"seg", de:[-0.07,80], a:[0.07,80], couleur:"ink3", epais:1.2},
    {t:"seg", de:[0,90], a:[6,90], couleur:"line", epais:1}, {t:"seg", de:[-0.07,90], a:[0.07,90], couleur:"ink3", epais:1.2},
    {t:"seg", de:[0,100], a:[6,100], couleur:"line", epais:1}, {t:"seg", de:[-0.07,100], a:[0.07,100], couleur:"ink3", epais:1.2},
    {t:"seg", de:[0,110], a:[6,110], couleur:"line", epais:1}, {t:"seg", de:[-0.07,110], a:[0.07,110], couleur:"ink3", epais:1.2},
    {t:"texte", x:-0.15, y:16.5, txt:"20", ancre:"end", taille:10, couleur:"ink3"},
    {t:"texte", x:-0.15, y:36.5, txt:"40", ancre:"end", taille:10, couleur:"ink3"},
    {t:"texte", x:-0.15, y:56.5, txt:"60", ancre:"end", taille:10, couleur:"ink3"},
    {t:"texte", x:-0.15, y:76.5, txt:"80", ancre:"end", taille:10, couleur:"ink3"},
    {t:"texte", x:-0.15, y:96.5, txt:"100", ancre:"end", taille:10, couleur:"ink3"},
  ...
  corr:["**Je commence par identifier les trois courbes.** L'ambre descend : c'est l'énergie potentielle, qui diminue à mesure que la bille perd de la hauteur.",
        ...
        "**Je lis sur l'axe vertical.** Le point bleu est à mi-chemin entre les graduations $40$ et $50$ : $E_c = 45$ @u{J}.",
 ...
 {id:"mc15", niveau:2, type:"num", enonce:"Un cycliste développe une puissance de $240$ @u{W} en roulant à la vitesse constante de $8{,}0$ @u{m/s}. Quelle est la valeur de sa force de traction, en @u{N} ?",
  ...
  diag:[{v:1920, m:"Tu as multiplié $240$ par $8{,}0$. Mais c'est la **puissance** qui vaut $F × v$ : pour trouver $F$, il faut diviser."},
        ...
        {v:240, m:"$240$ @u{W} est la puissance. Une force se mesure en newtons : il reste à diviser par la vitesse, $@f{240}{8{,}0} = 30$ @u{N}."}],
 ...
 {id:"mc16", niveau:3, type:"num", enonce:"Une pompe monte $200$ @u{kg} d'eau à $10$ @u{m} de hauteur en $50$ @u{s}. Quelle puissance développe-t-elle, en @u{W} ? On prend $g = 10$ @u{N/kg}.",
  ...
  diag:[{v:20000, m:"$20 000$ @u{J} est le **travail** fourni, pas la puissance. Il reste à le diviser par les $50$ @u{s}."},
        {v:2000, m:"Tu as divisé par $10$ au lieu de $50$ : c'est par la **durée** qu'on divise. $P = @f{20 000}{50} = 400$ @u{W}."},
