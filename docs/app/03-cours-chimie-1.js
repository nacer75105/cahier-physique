...
sections:[
 ...
 {id:"s5", titre:"Diluer une solution", blocs:[
  ...
  {t:"mots", items:[
   ["Pipette jaugée","Un tube de verre fin avec un trait gravé (parfois deux). Remplie jusqu'au trait puis vidée, elle **délivre** le volume inscrit dessus ($10{,}0$ @u{mL}, $20{,}0$ @u{mL}…), avec une toute petite incertitude."],
