...
sections:[
 ...
 {id:"s5", titre:"Molécule polaire, ou pas : la question de la symétrie", blocs:[
  ...
  {t:"figi", nom:"polarite"},
  {t:"p", x:"Dans cette figure, A est l'atome central, et les deux X sont les atomes qui l'entourent. Les deux conditions de la polarité se voient d'un coup sur cette figure. Mets l'écart d'électronégativité à **zéro** : plus aucune liaison n'est polarisée, et la molécule est apolaire quel que soit l'angle. Choisis ensuite **« Type CO₂ »**, règle l'écart sur $0{,}8$ et ouvre l'angle jusqu'à $180°$ : les deux oxygènes sont $δ^-$, le carbone central $δ^+$, les deux flèches s'opposent exactement et la résultante s'annule — c'est le $@c{CO_2}$. Avec **« Type H₂O »**, un écart de $1{,}2$ et un angle de $105°$, tu as la molécule d'eau, polaire. Il faut donc **les deux** : des liaisons polarisées, et une forme qui ne les compense pas."},
