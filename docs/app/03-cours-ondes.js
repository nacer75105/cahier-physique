...
{id:"s5", titre:"Les spectres : la signature des éléments", blocs:[
  ...
  {t:"check", q:"On observe un spectre continu barré de raies noires. Que peut-on en déduire ?",
   choix:["La source est un gaz chaud et peu dense",
          "La source est très froide",
          "Un gaz froid s'interpose entre la source chaude et nous","Le spectromètre est mal réglé"], bonne:2,
   expl:["Un gaz chaud et peu dense donnerait des raies **brillantes** sur fond noir, et non l'inverse.",
         "Un corps très froid n'émettrait presque rien dans le visible : il n'y aurait pas de fond continu du tout.",
         "Exact : le fond continu vient d'un corps chaud et dense, et les raies noires signalent un gaz plus froid qui a absorbé, sur le trajet, exactement les longueurs d'onde qu'il aurait émises. C'est ainsi qu'on analyse l'atmosphère des étoiles.",
  ...
  {t:"atelier", titre:"Du nanomètre à l'électronvolt",
   ...
   etapes:[
    ...
    {q:"Une diode bleue émet à $450$ @u{nm}. L'énergie de ses photons est…",
     choix:["plus petite que $2{,}0$ @u{eV}","la même, seule la couleur change","impossible à comparer sans refaire tout le calcul","plus grande que $2{,}0$ @u{eV}"],
     bonne:3,
     diag:["Plus la longueur d'onde est **courte**, plus la fréquence est grande, donc plus l'énergie est grande. Le bleu est plus court que le rouge.","Pour une lumière d'une seule couleur, couleur, longueur d'onde et énergie du photon vont ensemble : changer de couleur, c'est changer l'énergie.",
...
exos:[
 ...
 {id:"lu4", niveau:2, type:"qcm", enonce:"Deux photons, l'un bleu ($450$ @u{nm}), l'autre rouge ($700$ @u{nm}). Lequel transporte le plus d'énergie ?",
  choix:["Le rouge, car sa longueur d'onde est plus grande","Les deux transportent la même énergie",
         "Cela dépend de l'intensité de la source","Le bleu, car sa longueur d'onde est plus petite"], bonne:3,
  diag:["Dans $E = @f{hc}{λ}$, la longueur d'onde est au **dénominateur** : une grande longueur d'onde donne une petite énergie.",
...
{id:"lu9", niveau:1, type:"qcm", enonce:"On place un écran derrière une lentille convergente et on y voit apparaître l'image nette d'une bougie. Cette image est :",
  choix:["virtuelle et droite","réelle et renversée","réelle et droite","virtuelle et renversée"], bonne:1,
  diag:["Une image virtuelle ne peut **pas** être recueillie sur un écran : on ne la voit qu'en regardant à travers la lentille. Or ici elle se forme bien sur l'écran.",
        "",
...
{id:"lu13", niveau:2, type:"qcm", enonce:"Une lampe à vapeur de sodium est observée au spectroscope. On voit deux raies jaunes très brillantes sur fond noir. De quel type de spectre s'agit-il ?",
  choix:["Un spectre continu","Un spectre de raies d'émission",
         "Un spectre de raies d'absorption","Un spectre de bandes"], bonne:1,
  diag:["Un spectre continu présente toutes les couleurs sans interruption, du violet au rouge. Ici il n'y a que deux raies, et du noir partout ailleurs.",
        "",
...
{id:"lu15", niveau:3, type:"qcm",
  ...
  choix:["L'élément A","L'élément B","L'élément C","Aucun des trois"], bonne:2,
  diag:["L'élément A a bien une raie qui coïncide, la première — mais sa seconde raie, dans le rouge, ne correspond à aucune raie noire. Une seule coïncidence ne suffit pas : il les faut **toutes**.",
